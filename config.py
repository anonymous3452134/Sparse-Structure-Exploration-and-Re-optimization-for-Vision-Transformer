...
schedule_types = ["step", "multistep", "exp", "cosine"]


def get_train_args():
    parser = argparse.ArgumentParser(
        "Training DeiT based models using ImageNet", add_help=False
    )
    ...
    parser.add_argument(
        "--prune-freq", dest="prune_freq", default=8, type=int, help="update frequency"
    )
    parser.add_argument(
        "--prune-rate", dest="prune_rate", default=0.3, type=float, help="pruning rate"
    )
    parser.add_argument(
        "--prune-imp",
        dest="prune_imp",
    ...
    parser.add_argument("--warmup", default=1, type=int, help="warmup epoch ")
    parser.add_argument(
        "--target_epoch", default=70, type=int, help="target_pruning_epoch "
    )
...
def base_parser(parser):
    ...
    parser.add_argument(
        ...
        type=str,
        metavar="MODEL",
        help='Name of model to train (choose among :  "deit_tiny_patch16_224","deit_small_patch16_224","deit_base_patch16_224" or saved pt(fx symbolically traced) model)',
    )
